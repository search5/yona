...
| P3-45 | [ ] | 템플릿을 Tailwind CSS + htmx 기반으로 리팩터링 (2026-09-10 사용자 제안, 계획서만 작성 — 코드 0줄) | 계획서: [`docs/yona-wiki/plans/p3-45-tailwind-htmx-template-refactor.md`](../yona-wiki/plans/p3-45-tailwind-htmx-template-refactor.md), 파일 단위 백로그: [`docs/TAILWIND_HTMX_BACKLOG.md`](../TAILWIND_HTMX_BACKLOG.md)(182개 템플릿, 그룹 17개). `tailwindcss` 브랜치(`search5` remote)에서 진행. 화면 재설계 없이 Bootstrap 2.3.1/jQuery 3.3.1 → Tailwind/htmx 기술 스택만 교체 | [[tickets/p3-45]] |
